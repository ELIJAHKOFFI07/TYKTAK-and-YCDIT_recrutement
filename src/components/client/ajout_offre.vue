    ...
    <header>
            ...
            <nav>
                ...
                <ul class="navigation-menu">
                    ...
                    <li><a href="#">Fonctionnalites</a>
                        <ul class="subnav">
                            <li class="card-med" id="serv-groom">
                                <div class="card-image"><img src="../src/assets/ajouter.png"></div>
                                <a href="#">
                                    <span>Ajout d'appel d'offre</span>
                                    
                                </a>
                            </li>
                            <li class="card-med" id="serv-board">
                                <div class="card-image"><img src="../src/assets/gerer.png"></div>
                                <a href="#">
                                    <span>ses appels d'offres</span>
                    ...
                    <li><a href="#locate">Informations personnelles</a>
                    </li>
                    <!-- <li>
...
<section class="container information-processing-form rounded-2">
  <div class="row d-flex align-items-center">
    <div class="col-sm-6 d-block">
      <img src="../src/assets/enregistrement.jpg" width="100%" class="rounded-5">
    </div>
    <div class="col">
      <h3 class="text-center">Ajouter un appel d'offre</h3>

      <form method="post" class="p-5">
        <div class="form-floating mb-3">
        <select name="" id="" class="form-control shadow-none border-danger">
            <option value="">Selectionner un domaine</option>
            <option value="" class="text-black-50">domaine 1</option>
            <option value="" class="text-black-50">domaine 2</option>
        </select>
        <label for="" class="text-black-50" >Domaine</label>

        </div>
        <div class="form-floating mb-3">
          <input id="password" type="date" name="password" class="form-control shadow-none border-danger" required autocomplete="new-password" >
          <label for="password" class="text-black-50">Delai de candidature</label>

        </div>
        <div class="form-floating mb-3">
          <input id="password-confirm" type="number" class="form-control shadow-none border-danger" name="password_confirmation" required autocomplete="new-password" placeholder="nombre de poste disponible">
          <label for="password-confirm" class="text-black-50">Nombre de poste disponible</label>
        </div>

        <div class="form-floating mb-3">
          <input id="password-confirm" type="number" class="form-control shadow-none border-danger" name="password_confirmation" required autocomplete="new-password" placeholder="nombre de poste disponible">
          <label for="password-confirm" class="text-black-50">Limite d'age</label>
        </div>

        <div class="form-floating mb-3">
            <textarea class="form-control shadow-none border-danger" name="" placeholder="Mission principale" id="" cols="30" rows="10"></textarea>
            <label for="password" class="text-black-50">Mission principale</label>
        </div>

        <div class="form-floating mb-3">
            <textarea class="form-control shadow-none border-danger" name="" placeholder="activite principale" id="" cols="30" rows="10"></textarea>
            <label for="password" class="text-black-50">activite principale</label>
        </div>
        ...
        <button class="btn btn-danger w-100 mb-2" name="submit" type="submit">Valider</button>
...
.btn-danger {
    background-color: #b3a444 !important; /* Pour #EDDAA9 */
  ...
  border-color: #000000 !important;
    ...
    * {
    ...
    section.hero {
        /*    width: 100%;*/
        height: auto;
        background: var(--brand-02) url('../src/assets/3d_rech.png') no-repeat center right;
