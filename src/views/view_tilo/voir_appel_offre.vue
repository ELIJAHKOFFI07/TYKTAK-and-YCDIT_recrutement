<template>
    ...
    <section class="container information-processing-form rounded-2">
      <div class="row d-flex align-items-center">
        <!-- <div class="col-sm-6 d-block">
          <img src="../../assets/images_tilo/enregistrement.jpg" width="100%" class="rounded-5">
        </div> -->
        <div class="col">
          <h3 class="text-center">Modifier et voir les appels d'offre</h3>
      ...
      <tbody>
        <tr v-for="offre in offres" :key="offre.id_appel_doffre">
          <td>{{ offre.date_cloture }}</td>
          <td>{{ offre.nombre_de_poste_disponible }}</td>
          <td>{{ offre.age }}</td>
          <td>{{ offre.mission }}</td>
  ...
  axios.post('http://localhost/genie_logiciel/backend/backend_tilo/api_nouscontacter_entreprise.php?action=voir_appel', data)
    .then(response => {
      if (response.data.success) {
        console.log("Offres chargées:", response.data.offres);
