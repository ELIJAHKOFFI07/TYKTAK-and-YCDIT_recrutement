<template>
    <section class="tableau">
                    ...
                    <li><a href="#">Services</a>
                        <ul class="subnav">
                            ...
                            <li class="card-med" id="serv-board">
                                <div class="card-image"><img src="../../assets/images_tilo/appel_doffre.png"></div>
                                <a href="#">
        ...
        <section id="locate">
            ...
            <div>
                <h2>Pourquoi des chasseurs de tete</h2>
...
import { RouterLink } from 'vue-router';
    ...
    * {
    ...
    section.hero {
        /*    width: 100%;*/
        height: auto;
        background: var(--brand-02) url('../../assets/images_tilo/3d.png') no-repeat center right;
