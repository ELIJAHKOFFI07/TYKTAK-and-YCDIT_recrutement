...
<section>
    ...
    <header>
        ...
        <section class="hero">
            ...
            <h1>Chez nous, le temps ne se perd pas, il se transforme en opportunités.</h1>
            <div class="btn-group">
        ...
        <section id="locate">
            ...
            <div>
                ...
                <h6>Les chasseurs de tête, souvent appelés recruteurs spécialisés ou consultants en recrutement, jouent un rôle crucial dans le marché de l'emploi contemporain. Leur mission principale est d'identifier et d'attirer des candidats hautement qualifiés pour des postes spécifiques, généralement à des niveaux moyens à supérieurs de l'entreprise ou dans des domaines spécialisés.</h6>
  ...
  methods: {
    ...
    * {
    ...
    section.hero {
        /*    width: 100%;*/
        height: auto;
        background: var(--brand-02) url('../../assets/images_tilo/3d_rech.png') no-repeat center right;
