    ...
    <header>
            ...
            <nav>
                ...
                <ul class="navigation-menu">
                    ...
                    <li><a href="#locate">Localisation &amp; Heures</a>
                    </li>
                    <li>
        ...
        <div class="formbg-outer">
          <div class="formbg">
            <div class="formbg-inner padding-horizontal--48">
              <span class="padding-bottom--15">Entrez vos identifiants de connexion</span>
              <form id="stripe-login" @submit.prevent="se_connecter">
                <div class="field padding-bottom--24">
                  <label for="pseudo">Pseudo</label>
                  <input type="text" name="pseudo" v-model="connexion.pseudo">
                </div>
                <div class="field padding-bottom--24">
                  ...
                  <input type="password" name="password" v-model="connexion.mdp">
                </div>
...
import axios from "axios";
  ...
  if (!this.connexion.pseudo || !this.connexion.mdp) {
    alert("Veuillez renseigner tous les champs.");
    return;
  }

  var data = new FormData();
  data.append('pseudo', this.connexion.pseudo);
  data.append('mdp', this.connexion.mdp);

  axios.post('http://localhost/genie_logiciel/backend/backend_tilo/api_nouscontacter_entreprise.php?action=connexion', data)
  .then((response) => {
    const res = response.data;
    if (res.success) {
      // Stocker les informations de l'utilisateur dans l'état du composant
      this.user = res.user;
