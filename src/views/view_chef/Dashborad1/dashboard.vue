        ...
        <div id="main-wrapper">
            ...
            ***********************************-->
            <div class="nav-header">
                <a href="index.html" class="brand-logo">
                    ...
                    <p class="brand-title" width="124px" height="33px"  style="font-size: 30px;">Candidat</p>
                </a>
                    ...
                    <nav class="navbar navbar-expand">
                        <div class="collapse navbar-collapse justify-content-between">
                            ...
                            <ul class="navbar-nav header-right">
                                ...
                                <li class="nav-item">
                                    <a href="javascript:void(0);" class="btn btn-primary d-sm-inline-block d-none">Se déconnecter<i class="las la-signal ms-3 scale5"></i></a>
                                </li>
                            </ul>
                        </div>
                    </nav>
                    ...
                    <ul class="metismenu" id="menu">
                        <li class="dropdown header-profile">
                            <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                                ...
                                <div class="header-info ms-3">
                                    <span class="font-w600 ">Konate,<b>Tilonon</b></span>
                        ...
                        <li><a href="javascript:void()" aria-expanded="false">
                            <i class="flaticon-050-info"></i>
                                <span class="nav-text">Appel D'offre</span>
                            </a>
                        </li>
                        <li><a href="javascript:void()" aria-expanded="false">
                                <i class="flaticon-041-graph"></i>
                                <span class="nav-text">Entretien</span>
                            </a>
                        </li>
                        <li><a href="javascript:void()" aria-expanded="false">
                                <i class="flaticon-086-star"></i>
                                <span class="nav-text">Test Psychotechnique</span>
                            </a>
                        </li>
            ...
            ***********************************-->
            <div class="content-body" >
                <!-- row -->
                <div class="container-fluid" v-if="test">
                        ...
                        <div class="col-xl-3 col-xxl-3 col-sm-6">
                            <div class="card bg-warning invoice-card">
                                <div class="card-body d-flex">
                                    ...
                                    <div>
                                        <h2 class="text-white invoice-num">240</h2>
                                        <span class="text-white fs-18">Appel d'offre </span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card bg-success invoice-card">
                                <div class="card-body d-flex">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-white fs-18">Entretien </span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-xxl-3 col-sm-6">
                            <div class="card bg-info invoice-card">
                                <div class="card-body d-flex">
                                    ...
                                    <div>
                                        <h2 class="text-white invoice-num">5</h2>
                                        <span class="text-white fs-18">Test psychotechnique</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card bg-secondary invoice-card">
                                <div class="card-body d-flex">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-white fs-18">Taux d'admission</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-xxl-7">
                            <div class="card">
                                <div class="card-header border-0 pb-0">
                                    <div>
                                        <h4 class="card-title mb-2">Test Auditif</h4>
                                        <span class="fs-12">Ecrivez ce que vous entendrez</span>
                                    </div>
                                    <div class="dropdown">
                                ...
                                <div class="card-body">	
                                    ...
                                    <h4 class="mt-3 mb-0">Votre réponse:</h4>
                                    ...
                                    <div class="text-secondary fs-16 d-flex justify-content-between font-w600 mt-4">
                                        <span>Points:5 </span>
                                        <span>Temps restant: 19s</span>
                                    </div>
                                </div>
                                <div class="card-footer border-0 pt-0">
                                    <a href="javascript:void(0);" class="btn btn-primary d-block btn-lg text-uppercase">Valider</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-xxl-5">
                            <div class="card">
                                <div class="card-header border-0 pb-0">
                                    <div>
                                        <h4 class="card-title mb-2">Test de Couleur</h4>
                                        <span class="fs-12">Choissisez la couleur la plus foncée</span>
                                    </div>
                                    <div class="dropdown">
                                        <a href="javascript:void(0);" class="btn-link" data-bs-toggle="dropdown" aria-expanded="false">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="card-body">	
                                    ...
                                    <div class="d-flex align-items-end mt-2 pb-3 justify-content-between">
                                        <span><em><strong>A</strong></em></span>
                                        <span class="fs-18"><span class="text-black pe-2">Bleu</span></span>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-end mt-2 pb-3 justify-content-between">
                                        <span>B</span>
                                        <span class="fs-18"><span class="text-black pe-2">Violet</span></span>
                                    </div>
                                    <div class="progress default-progress mt-4">
                                    ...
                                    <div class="d-flex align-items-end mt-2 pb-3 justify-content-between">
                                        <span>C</span>
                                        <span class="fs-18"><span class="text-black pe-2">Indigo</span></span>
                                    </div>
                                    <div class="progress default-progress mt-4">
                                    ...
                                    <div class="d-flex align-items-end mt-2 justify-content-between">
                                        <span>D</span>
                                        <span class="fs-18"><span class="text-black pe-2">Noir</span></span>
                                    </div>
                                </div>
                                <div class="card-footer border-0 pt-0">
                                    <a href="javascript:void(0);" class="btn btn-outline-primary d-block btn-lg">Valider</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6 col-xxl-12">
                            <div class="card">
                                <div class="card-header d-block d-sm-flex border-0">
                                    <div class="me-3">
                                        <h4 class="card-title mb-2">Appel d'offre</h4>
                                        <span class="fs-12">Vos différents Appels d'offre</span>
                                    </div>
                                            ...
                                            <table class="table table-responsive-md card-table transactions-table">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h6 class="fs-16 font-w600 mb-0">Reseaux informatiques</h6>
                                                            <span class="fs-14">Test Psychotechnique</span>
                                                        </td>
                                                        <td>
                                                            <h6 class="fs-16 text-black font-w600 mb-0">4 Aout 2024</h6>
                                                            <span class="fs-14">05:34:45 AM</span>
                                                        </td>
                                                        <td><span class="fs-16 text-black font-w600">+$5,553</span></td>
                                                        <td><span class="text-success fs-16 font-w500 text-end d-block">Succés</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <h6 class="fs-16 font-w600 mb-0"><a href="javascript:void(0);" class="text-black">Base de Donées </a></h6>
                                                            <span class="fs-14">Entretien</span>
                                                        </td>
                                                        <td>
                                                            <h6 class="fs-16 text-black font-w600 mb-0">4juillet 2024</h6>
                                                            <span class="fs-14">05:34:45 AM</span>
                                                        </td>
                                                        <td><span class="fs-16 text-black font-w600">-$167</span></td>
                                                        <td><span class="text-light fs-16 font-w500 text-end d-block">En Attente</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <svg class="bgl-success tr-icon" width="63" height="63" viewBox="0 0 63 63" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="col-xl-12">
                                    <div class="card coin-card">
                                        <div class="card-body d-sm-flex d-block align-items-center">
                                            ...
                                            <div>
                                                <h3 class="text-white">Plateforme Entretien</h3>
                                                <p>C'est l'une des étapes les plus difficiles , mais en étant bien preparer on y parviens  </p>
                                                <p><em> le 25 janvier TikTak</em></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
          ...
          >
            ...
            ***********************************-->
            <div class="footer">
                ...
                <div class="copyright">
                    <p>© Designed &amp; by <a href="#" target="_blank">TikTaK </a> 2024</p>
                </div>
            </div>
            <!--**********************************
                Footer end
...
<script setup>
import{ref} from 'vue'
import Test from'./quiz/quiz.vue'
const test=ref(true);
const load= ()=>(test.value=!test.value)
...
@import url('./vendor/jquery-nice-select/css/nice-select.css');
@import url('./vendor/nouislider/nouislider.min.css');
